...
<div class="headerBar">
	<div class="logoBar login_logo">
		<div class="comWidth">
			<div class="logo fl">
				<a href="#"><img src="admin/images/logo.jpg" alt="慕课网"></a>
			</div>
...
<div class="loginBox">
	...
	<form action="admin/doLogin.php" method="post">
			<ul class="login">
				...
				<img src="admin/getveryfun.php" alt="" />
...
<div class="footer">
	...
	<p class="web"><a href="#"><img src="admin/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="admin/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="admin/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="admin/images/webLogo.jpg" alt="logo"></a></p>
</div>
</body>
</html>
